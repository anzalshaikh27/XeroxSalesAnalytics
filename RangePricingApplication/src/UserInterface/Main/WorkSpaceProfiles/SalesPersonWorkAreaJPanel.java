...
import UserInterface.Main.PerformanceReportJPanel;
...
//        CardSequencePanel.add("ManageVulns", aos);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        // Get the Master Solution Order List
//        MasterSolutionOrderList masterSolutionOrderList = business.getMasterSolutionOrderList();
//
//        // Get the Market-Channel-Combo Catalog
//        MarketChannelComboCatalog comboCatalog = business.getMarketChannelComboCatalog();
//
//        // Calculate and display top 3 negotiated solutions broken down by market segments
//        System.out.println("Top 3 Negotiated Solutions:");
//
//        // Iterate over all market-channel combos
//        for (MarketChannelAssignment combo : comboCatalog.finMarketChannelCombo(market,channel)) {
//            double actualRevenue = masterSolutionOrderList.getRevenueByMarketChannelCombo(combo);
//            double targetRevenue = combo.getRevenues();
//
//            // Check if the solution is negotiated (actual revenue > target revenue)
//            if (actualRevenue > targetRevenue) {
//                // Display details for negotiated solution
//                System.out.println("Market-Channel Combo: " + combo);
//                System.out.println("Actual Revenue: " + actualRevenue);
//                System.out.println("Target Revenue: " + targetRevenue);
//                System.out.println("Negotiated Amount: " + (actualRevenue - targetRevenue));
//                System.out.println();
//            }
//        }
...
//        CardSequencePanel.add("ManageRiskProfiles", drpd);
    ...
    // Assuming PerformanceReportJPanel takes Business and CardSequencePanel as arguments
    PerformanceReportJPanel performanceReportPanel = new PerformanceReportJPanel(business, CardSequencePanel);

    // Before adding the new panel, remove all the previous ones
    CardSequencePanel.removeAll();
    
    // Add the new panel to the CardSequencePanel
    CardSequencePanel.add("PerformanceReportPanel", performanceReportPanel);
