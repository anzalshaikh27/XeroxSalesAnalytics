...
//        solutiontvteen.setTotalPrice(1000);
        solutiontvteen.setTotalPrice(solutiontvteen.getTotalPrice());
...
//        solutionwebteen.setTotalPrice(500);
        solutionwebteen.setTotalPrice(solutionwebteen.getTotalPrice());
        
        // Create Solution Offers for College Grads
        MarketChannelAssignment tvchannelCollegeGrads = mccc.newMarketChannelCombo(teenmarket2, tvchannel);
        MarketChannelAssignment webchannelCollegeGrads = mccc.newMarketChannelCombo(teenmarket2, webchannel);

        SolutionOffer solutiontvCollegeGrads = solutionoffercatalog.newSolutionOffer(tvchannelCollegeGrads);
        solutiontvCollegeGrads.addProduct(products2p2);
        solutiontvCollegeGrads.addProduct(products2p1);
//        solutiontvCollegeGrads.setTotalPrice(1200);
        solutiontvCollegeGrads.setTotalPrice(solutiontvCollegeGrads.getTotalPrice());


        SolutionOffer solutionwebCollegeGrads = solutionoffercatalog.newSolutionOffer(webchannelCollegeGrads);
        solutionwebCollegeGrads.addProduct(products2p2);
        solutionwebCollegeGrads.addProduct(products2p1);
//        solutionwebCollegeGrads.setTotalPrice(600);
        solutionwebCollegeGrads.setTotalPrice(solutionwebCollegeGrads.getTotalPrice());
        ...
        // Create Solution Orders for College Grads
        SolutionOrder soCollegeGradsTV = msol.newSolutionOrder(solutiontvCollegeGrads, tvchannelCollegeGrads);
        SolutionOrder soCollegeGradsWeb = msol.newSolutionOrder(solutionwebCollegeGrads, webchannelCollegeGrads);
        
        msol.getRevenueByMarketChannelCombo(tvchannelteenmarket);
        msol.getRevenueByChannel(tvchannel);
        
        // Display revenue for College Grads
        msol.getRevenueByMarketChannelCombo(tvchannelCollegeGrads);
        msol.getRevenueByChannel(tvchannel);
